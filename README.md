...
A command-line prototype of UNO with some custom twists. This repository contains a minimal playable version (v1)
focused on core card mechanics and a clear roadmap toward GUI and LAN multiplayer.

### Overview

A lightweight UNO clone implemented in Java using Maven. Version 1 is a CLI prototype that supports basic card play and
a simple computer opponent. Future plans include additional game modes, a graphical UI using LibGDX, and LAN-based local
multiplayer.
